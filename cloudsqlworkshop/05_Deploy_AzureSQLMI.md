...
<h2><img style="float: left; margin: 0px 15px 15px 0px;" src="https://github.com/microsoft/sqlworkshops/blob/master/graphics/pencil2.png?raw=true"><b><a name="5-0">     5.0 Using parquet files with Azure Blob Storage</a></b></h2>

In this exercise you will learn how to use the T-SQL function OPENROWSET to access parquet files in a public dataset in Azure Blob Storage.
...
## Using a S3 compatible object provider for data virtualization and object storage

Put your knowledge to test by setting up a S3 compatible object provider and using new data virtualization and object storage capabilities.
